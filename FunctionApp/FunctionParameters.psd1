@{
    ...
    _EntraEnvironmentName                         = @{Required = $false ; Type = 'string' ; Default = 'Global'                            ; Description = 'The environment name of the Entra ID tenant for connecting to Microsoft Graph. Could be: Global, China, USGov, USGovDoD, China' }
