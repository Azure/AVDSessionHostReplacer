...
Remove-Module SessionHostReplacer -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\SessionHostReplacer.psd1"
Import-Module "$PSScriptRoot\..\SessionHostReplacer.psm1" -Force
